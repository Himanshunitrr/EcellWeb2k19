  ...
  render() {
    ...
    return (
      <div className="Navbar">
        ...
        <div
          className={`toggle ${this.state.active ? "active1" : ""}`}
          onClick={() => this.setState({ active: !this.state.active })}
        ></div>
        <div className={`left-sidebar ${this.state.active ? "active1" : ""}`}>
          <div className="logoback2">
            <img className="logo2" alt="Ecell Logo" src={logo}></img>
          </div>
        </div>
        <div className={`sidebar ${this.state.active ? "active1" : ""}`}>
          <ul>
            <li>
              <Link to="/" className="data-links" data-text="Home">
                Home
              </Link>
            </li>
            <li>
              <NavLink to="/events" className="data-links" data-text="events">
                Events
              </NavLink>
            </li>
            <li>
              <NavLink to="/team" className="data-links" data-text="Team">
                Team
              </NavLink>
            </li>
            <li>
              <NavLink to="/gallery" className="data-links" data-text="Gallery">
                Gallery
              </NavLink>
            </li>
            <li>
            ...
            <li>
              <NavLink to="/mentors" className="data-links" data-text="Mentors">
                Mentors
              </NavLink>
            </li>
            <li>
            ...
            <li>
              <a
                href="https://medium.com/e-cell-nit-raipur"
                className="data-links"
                data-text="Blogs"
              >
                Blogs
